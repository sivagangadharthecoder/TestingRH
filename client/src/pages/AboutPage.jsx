...
import '../styles/AboutPage.css'; // We'll create this CSS file
    ...
    <div className="about-container">
      ...
      <section className="about-hero-section">
        ...
        {/* <div className="about-hero-image">
          <div className="about-floating-card about-card-1">📋</div>
          <div className="about-floating-card about-card-2">✅</div>
          <div className="about-floating-card about-card-3">📧</div>
        </div> */}
      </section>
