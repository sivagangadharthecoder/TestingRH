...
function InternshipApproved() {
    ...
    const fetchApplications = async () => {
        try {
            const response = await fetch("http://localhost:5000/api/applicationsApproved");
    ...
    const handleApprove = async (id) => {
        try {
            const response = await fetch("http://localhost:5000/api/approve-application", {
                method: "PUT",
                headers: {
    ...
    const handleReject = async (id) => {
        try {
            const response = await fetch("http://localhost:5000/api/reject-application", {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
