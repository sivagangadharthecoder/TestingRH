...
function HackthonApproved() {
    ...
    const fetchApplications = async () => {
        try {
            const response = await fetch("http://localhost:5000/api/applications2Approved");
            if (!response.ok) {
    ...
    const handleApprove = async (id) => {
        try {
            ...
            const response = await fetch("http://localhost:5000/api/approve-application2", {
                method: "PUT",
                headers: {
    ...
    const handleReject = async (id) => {
        try {
            ...
            const response = await fetch("http://localhost:5000/api/reject-application2", {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            console.log("Reject response status:", response.status); // Add logging
            const data = await response.json();
            console.log("Reject response data:", data); // Add logging
